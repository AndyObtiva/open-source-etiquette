...
As an Open-Source Project Author:
...
- If you fail to meet a promise you made to someone or a deadline you agreed to, do not apologize as that will come across as empty words without any action to back them up, thus making matters worse! Instead, silently work as hard and fast as you can on finishing the promised output that you are delayed with and only respond with an apology once you have something fully finished that would redeem you. 

As an Open-Source Project User:
